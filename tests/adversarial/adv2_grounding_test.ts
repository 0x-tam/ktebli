...
// RE-ATTACK #4 2026-08-28: the NAME branch (shared>=2) admitted on bare INTERSECTION, so
// two DIFFERENT names overlapping only on topic words were conflated. A confident name
