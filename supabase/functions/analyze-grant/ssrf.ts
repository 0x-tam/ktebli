// Shared SSRF-safe fetch for anywhere the server fetches a user-supplied URL.
// Blocks loopback, private, link-local, CGNAT, cloud-metadata and non-HTTP(S)
// targets; parses and re-validates EVERY redirect hop; caps time, redirects
// and response size.
